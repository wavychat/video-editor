...
export interface FreeDrawingBrush {
	...
	globalCompositeOperation?: "destination-out" | "destination-over";
}
...
export class StaticCanvas {
	...
	setWidth(
		value: number | string,
		options?: ICanvasDimensionsOptions
	): Canvas;
	...
	/**
	 * Go back in history.
	 * **Only works when history is initialized with `fabric-history`**
	 * @return {void}
	 */
	undo?: () => void;
	 ...
	 */
	toDatalessJSON(propertiesToInclude?: (keyof Object)[]): string;
	 ...
	 * @return {String} JSON string
	 */
	toJSON(propertiesToInclude?: (keyof Object)[]): string;
	 ...
	 */
	toObject(propertiesToInclude?: (keyof Object)[]): IToObject;
	 ...
	 * @return {Object} object representation of an instance
	 */
	toDatalessObject(propertiesToInclude?: (keyof Object)[]): any;
...
export interface WebglFilterBackend
	extends FilterBackend,
		WebglFilterBackendOptions {
